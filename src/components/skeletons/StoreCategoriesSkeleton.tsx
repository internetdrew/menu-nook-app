...
const StoreCategoriesSkeleton = () => {
  return (
    <div
      role="status"
      aria-label="Loading store categories"
      data-testid="store-categories-skeleton"
      className="space-y-4"
    >
      <span className="sr-only">Loading store categories</span>
