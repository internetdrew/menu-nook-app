...
import type { StorePreviewItem } from "@/types/store";
...
type StoreItem = StorePreviewItem;
...
export function SortableStoreItemRow({
  item,
  categoryId,
  onEditItem,
  onDeleteItem,
  ...
  item: StoreItem;
  categoryId: number;
  onEditItem: (item: StoreItem, categoryId: number) => void;
  onDeleteItem: (item: StoreItem, categoryId: number) => void;
}) {
  const {
    attributes,
    listeners,
