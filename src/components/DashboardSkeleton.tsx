      ...
      <main>
        ...
        <div className="my-4 grid grid-cols-1 items-start gap-4 sm:grid-cols-2 md:grid-cols-3">
          <div className="rounded-xl border p-6">
            <Skeleton className="h-6 w-28 rounded-sm bg-neutral-200" />
            <Skeleton className="mt-6 h-8 w-8 rounded-md bg-neutral-200" />
          </div>
          <div className="rounded-xl border p-6">
            <Skeleton className="h-6 w-24 rounded-sm bg-neutral-200" />
            <Skeleton className="mt-6 h-8 w-8 rounded-md bg-neutral-200" />
          </div>
        </div>
      </main>
