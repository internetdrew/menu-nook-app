...
import { SortableStoreItemRow } from "./SortableStoreItemRow";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
type StoreCategory = StorePreviewCategory;

const getCategorySortableId = (categoryId: number) => `category-${categoryId}`;

export function SortableStoreCategorySection({
  category,
  isOpen,
  onAddItem,
  onEditCategory,
  ...
  isOpen: boolean;
  onAddItem: (category: StoreCategory) => void;
  onDeleteCategory: (category: StoreCategory) => void;
  onEditCategory: (category: StoreCategory) => void;
  onEditItem: (
    item: StoreCategory["items"][number],
    category: StoreCategory,
  ) => void;
  onDeleteItem: (
    item: StoreCategory["items"][number],
